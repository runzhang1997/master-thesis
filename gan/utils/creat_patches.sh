...
# creat training dataset, --run_60 is optional
#for file in ../../sentinel_data/train_data/unzip/*;do
#        #echo "$file"
#        python create_patches.py $file/
#done

# creat testing dataset --run_60 is optional
